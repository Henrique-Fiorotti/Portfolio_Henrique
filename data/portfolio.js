...
export const projects = [{
  ...
  description: "Plataforma para monitoramento de máquinas e sensores, gestão de alertas e equipes, relatórios e assistência operacional por IA, com atualizações em tempo real.",
  image: "/images/optimized/orbis-project.webp",
  ...
  image: "/images/optimized/producplus-project.webp",
  ...
  image: "/images/optimized/hubit-project.webp",
  ...
  description: "API para gerenciamento de usuários com CRUD, validação via Pydantic, respostas seguras, tratamento de erros e documentação automática com Swagger e ReDoc.",
  image: "/images/optimized/fastapi-rest-api.webp",
  ...
  description: "API REST simples para consulta de produtos, desenvolvida como estudo prático de rotas, recursos HTTP e construção de serviços com Node.js e Express.",
  image: "/images/optimized/node-express-product-api.webp",
  ...
  description: "Sistema de reservas online para uma concessionária especializada em carros japoneses, com criação de conta, autenticação e gerenciamento de reservas.",
  image: "/images/optimized/hcg.webp",
  ...
  description: "Experimento visual inspirado no design brutalista, desenvolvido para explorar composição, tipografia e interações digitais marcantes.",
  image: "/images/optimized/brutalist-project.webp",
  ...
  description: "Site de vendas especializado em chocolates artesanais, com experiência visual envolvente e uma interface adaptada a diferentes telas.",
  image: "/images/optimized/leitzo-project.webp",
  ...
  description: "Aplicação de lista de tarefas que reúne as quatro operações fundamentais de persistência em uma interface direta e funcional.",
